...
6. **Network analysis:** Bipartite **geneÐpathway** graph, degree centrality to identify pathway hubs.
...
- **Import-like scoring is a proxy:** The mutagenesis ÒscoreÓ reflects modeled features and embedding changes, not measured TOM/TIM import kinetics.
